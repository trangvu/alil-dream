...
cd $SRC_PATH && python ALIL-simulation.py --root_dir $ROOT_DIR --dataset_name $DATASET_NAME --text_data_dir $TEXT_DATA_DIR \
    --word_vec_dir $DATA_DIR/word_vec/$EMBEDING_FILE --episodes 100 --timesteps 80 \
    --output $OUTPUT --embedding_dim $EMB_DIM --label_data_size 100 --annotation_budget 100 \
