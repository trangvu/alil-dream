...
ndream=$1
budget=$2
OUTPUT=$OUT_DIR/sens_dreaming_${ndream}_${budget}_${DATASET_NAME}_${EXP_NAME}_${DATE}
mkdir -p $OUTPUT
...
cd $SRC_PATH && python AL-crf-dreaming.py --root_dir $ROOT_DIR --dataset_name $DATASET_NAME  \
    ...
    --ndream $ndream --dreaming_budget $budget --al_candidate_selection_mode uncertainty
rm -r -f $CACHE_PATH