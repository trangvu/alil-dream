...
OUTPUT=$OUT_DIR/dreaming_ibo_${DATASET_NAME}_${EXP_NAME}_${DATE}
mkdir -p $OUTPUT
...
cd $SRC_PATH && python AL-crf-dreaming.py --root_dir $ROOT_DIR --dataset_name $DATASET_NAME  \
    ...
    --ndream 5 --dreaming_budget 10 --ibo_scheme --al_candidate_selection_mode uncertainty
rm -r -f $CACHE_PATH